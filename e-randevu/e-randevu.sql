...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 24 May 2017, 18:22:37
...
INSERT INTO `doktor` (`id`, `polikinlikID`, `doktorAdi`) VALUES
(1, 7, 'ALPER DEMİRBAŞ'),
(2, 7, 'EMRE ŞİMŞEK'),
(3, 7, 'BARIŞ DİLLİ'),
(4, 7, 'OGÜN KARAMAHMUT'),
(5, 7, 'ZEHRA ÇİNKILIÇ'),
(6, 7, 'ALİ ŞAHİN AYDOĞAN');
...
INSERT INTO `hastane` (`id`, `ilceID`, `hastaneAdi`) VALUES
(1, 143, 'EMRE ŞİMŞEK DEVLET HASTANESİ'),
(2, 143, 'OGÜN KARAMAHMUT DEVLET HASTANESİ'),
(3, 143, 'ALPER DEMİRBAŞ DEVLET HASTANESİ'),
(4, 143, 'ZEHRA ÇİNKILIÇ DEVLET HASTANESİ'),
(5, 143, 'BARIŞ DİLLİ DEVLET HASTANESİ'),
(6, 143, 'ALİ ŞAHİN AYDOĞAN DEVLET HASTANESİ');
...
--
-- Tablo için tablo yapısı `polikinlik`
--

CREATE TABLE `polikinlik` (
  `id` int(11) NOT NULL,
  `hastaneID` int(11) NOT NULL,
  `polikinlikAdi` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin5;

--
-- Tablo döküm verisi `polikinlik`
--

INSERT INTO `polikinlik` (`id`, `hastaneID`, `polikinlikAdi`) VALUES
(1, 1, 'ÇOCUK CERRAHİ POLİKLİNİĞİ'),
(2, 1, 'ÇOCUK KARDİYOLOJİ POLİKLİNİĞİ'),
(3, 1, 'ÇOCUK GELİŞİM POLİKLİNİĞİ'),
(4, 1, 'ÇOCUK ALLERJİ POLİKLİNİĞİ'),
(5, 1, 'ENGELLİ HASTA POLİKLİNİĞİ'),
(6, 1, 'GÖĞÜS HASTALIKLARI POLİKLİNİĞİ '),
(7, 1, 'KUDUZ POLİKLİNİĞİ'),
(8, 1, 'SİGARA BIRAKMA POLİKLİNİĞİ');
...
INSERT INTO `randevu` (`randevu_id`, `tckn`, `saat`, `dAdi`, `hAdi`, `pAdi`) VALUES
(1234575, 1234567, '16:00', 'OGÜN KARAMAHMUT ', 'EMRE ŞİMŞEK DEVLET HASTANESİ ', 'KUDUZ POLİKLİNİĞİ '),
(1234572, 1234567, '15:40', 'OGÜN KARAMAHMUT ', 'EMRE ŞİMŞEK DEVLET HASTANESİ ', 'KUDUZ POLİKLİNİĞİ ');
...
INSERT INTO `saatler` (`id`, `doktorID`, `saatAdi`) VALUES
(1, 4, '09:20'),
(2, 4, '09:40'),
(3, 4, '10:00'),
(4, 4, '10:20'),
...
CREATE TABLE `user` (
  ...
  `user_Password` varchar(16) COLLATE utf8_turkish_ci NOT NULL,
  `onay` int(11) NOT NULL DEFAULT '0',
  `dogrulama` varchar(15) COLLATE utf8_turkish_ci NOT NULL
...
INSERT INTO `user` (`user_ID`, `user_TC`, `user_Name`, `user_Surname`, `user_Phone`, `user_Mail`, `user_Password`, `onay`, `dogrulama`) VALUES
(1, '1234567', 'emre', 'şimşek', '5383977808', 'emresimse55k801@gmail.com', '123456789', 1, ''),
(19, '25963147598', 'emre', 'şimşek', '52316996588', 'emresimsegfk801@gmail.com', 'lalocan3152', 1, '599131490'),
(20, '17329481725', 'emre', 'şimşek', '05383977808', 'emresimsek801@gmail.com', '123456789', 1, '1107638049');
...
--
-- Tablo için indeksler `polikinlik`
--
ALTER TABLE `polikinlik`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hastane`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- Tablo için AUTO_INCREMENT değeri `polikinlik`
--
ALTER TABLE `polikinlik`
...
--
ALTER TABLE `randevu`
  MODIFY `randevu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1234577;
--
